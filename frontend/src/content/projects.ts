...
export const projects: Project[] = [
  ...
  },
  {
    slug: "quanthub",
    title: "QuantHub",
    description: "Quanthub is an ongoing, quantitative finance trader workstation. Implemented exclusively in python, Quanthub aspires to be the one stop shop for quantitative-backed research and trader tools. Currently, the app supports synthetic price modeling with a geometric brownian motion, as well as real time equity data from the Interactive Brokers API. All calls to the IBKR API get stored in a SQLite database and the program checks the database before calling the API. Furthermore, Quanthub offers an options lab where-in you can generate Black Scholes call/put prices for any arbitrary parameterization, look at real time option chains, and observe the volatility surface for a given chain. While this project is ongoing, and has no endpoing, it is still useful in its infancy for traders and anyone interested in the space.",
